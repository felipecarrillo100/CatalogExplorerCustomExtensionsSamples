...
export const EnglishDictionary: Dictionary = {
   "en": {
       ...
       "main.navbarActionsLabel.ReactWindows": {value: "Windows with ReactJS"},
       "main.navbarActionsLabel.ReactWindows.SampleWindow": {value: "Example Window with ReactJS"},
       "main.navbarActionsLabel.ReactWindows.ListFeatures": {value: "List Features"},
       ...
       "bioFormSchema.schema.title": {value:"Bio"},
